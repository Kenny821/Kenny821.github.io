...
function parseHSL(hslStr: string): HSL {
  ...
  if (!match) return { h: 25, s: 90, l: 55 };
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '25 90 55', // Nice orange HSL
  backgroundColor = '#111112',
  borderRadius = 12, // match portfolio card borders (usually rounded-xl is 12px)
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#f27d26', '#ff9f55', '#333333'],
  fillOpacity = 0.4,
}) => {
